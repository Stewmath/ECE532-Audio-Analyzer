...
module multiplexer(
    ...
    wire wave_tready, spectrogram_tready;
    
    assign smpl_axis_tready = wave_tready && spectrogram_tready;
    wire smpl_valid = smpl_axis_tvalid && smpl_axis_tready;
    ...
    draw_waveform #(
        ...
        .s00_axis_tready(wave_tready),
        .s00_axis_tdata(smpl_axis_tdata),
        .s00_axis_tvalid(smpl_valid)
    );
    ...
    draw_spectrogram #(
        ...
        .s00_axis_aclk(smpl_axis_aclk),
        .s00_axis_aresetn(smpl_axis_aresetn),
        .s00_axis_tready(spectrogram_tready),
        .s00_axis_tdata(smpl_axis_tdata),
        .s00_axis_tvalid(smpl_valid),
